...
export function TimestampParserPanel() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div className="space-y-3">
        <label className="label" htmlFor="timestamp-input">
          <span className="label-text font-medium">Timestamp Input</span>
        </label>
        <textarea
          id="timestamp-input"
          value={input}
      ...
      <div className="space-y-3">
        <label className="label">
          <span className="label-text font-medium">Parsed Timestamp</span>
        </label>
              ...
              <div className="bg-card rounded-lg border border-[hsl(var(--border))] p-3">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <span className="text-purple-600 dark:text-purple-400 font-mono text-base break-all">
                      {parsed.selectedTimezone}
                    </span>
                  </div>
                  <div className="flex flex-col gap-1">
